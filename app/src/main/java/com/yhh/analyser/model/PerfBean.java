...
public class PerfBean {
    private static String TAG= LogUtils.DEBUG_TAG+"PerfBean";
    ...
    private static PerfBean mPerfBean;
    ...
    public static PerfBean getInstance(){
        if(mPerfBean ==null){
            mPerfBean = new PerfBean();
        }
        return mPerfBean;
    }
...
//        rtn = mPerf.perfLockAcquire(0, sources);
    ...
    private static int getNodeValue(String cmd){
        ...
        try {
            ...
            Log.e(TAG,"getNodeValue Exception");
        }
        return value;
    }
