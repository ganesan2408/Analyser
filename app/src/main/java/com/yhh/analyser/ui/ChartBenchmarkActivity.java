...
public class ChartBenchmarkActivity extends ChartBaseActivity {
    private static final String TAG = ConstUtils.DEBUG_TAG + "ChartBenchmarkActivity";
    ...
    private void initData(){
        ...
        new Thread(new Runnable(){
            ...
            @Override
            public void run() {
                mMonitorDataProvider = new MonitorDataProvider(ChartBenchmarkActivity.this);
