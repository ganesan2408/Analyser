...
import com.yhh.analyser.provider.LogProvider;
...
import com.yhh.analyser.widget.chart.items.BarChartItem;
import com.yhh.analyser.widget.chart.items.ChartItem;
import com.yhh.analyser.widget.chart.items.ExtendBarChartItem;
...
public class ChartLogActivity extends ChartBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTargetLog = b.getString(LogAnalyActivity.LOG_PATH);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if(item.getItemId() ==R.id.chart_noscroll){
            ...
            if(mTargetLog.endsWith(LogSleepParser.newFile)){
                Intent intent = new Intent(this, ChartSleepActivity.class);
    ...
    private void initData(){
        ...
        new Thread(new Runnable(){
            ...
            @Override
            public void run() {
                mLogProvider = new LogProvider(ChartLogActivity.this);
    ...
    private void updateAdapter(){
        ...
        if(mTargetLog.endsWith(LogBatteryParser.newFile)){
        ...
        }else if(mTargetLog.endsWith(LogPmParser.newFile)){
        ...
        }else if(mTargetLog.endsWith(LogSleepParser.newFile)){
