...
public class ChartSleepActivity extends ChartBaseActivity implements  OnChartValueSelectedListener {
    ...
    private LogSleepAbtractLogSleepParser mSleepLogParser;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.sleep_detail_btn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DialogUtils.showAlergDialog(ChartSleepActivity.this, "休眠与唤醒统计", mWakeupContent);
            }
        });
    }
...
//        final String parentDir = pref.getString("log_dir", "");
        final String parentDir = LogAnalyActivity.mParseDir;
        ...
        new Thread(new Runnable(){
            ...
            @Override
            public void run() {
//                mSleepLogParser = new LogSleepAbtractLogSleepParser(LogAnalyActivity.sParseDir);
                if(DEBUG){
                    Log.d(TAG,"sleep log parser: " + parentDir);
                }
                mSleepLogParser = new LogSleepAbtractLogSleepParser(parentDir);
                mSleepLogParser.parse(AbtractLogSleepParser.DATA_NEWEST);
    ...
    private void setData() {
        ...
        int index =0;
        ArrayList<LogWakeup> infoList = mSleepLogParser.getWakeupList().getInterruptList();
        for(LogWakeup info:infoList){
