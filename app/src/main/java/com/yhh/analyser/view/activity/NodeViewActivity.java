...
public class NodeViewActivity extends BaseActivity {
    ...
    public void initUI() {
        ...
        mNodeList.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            @Override
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                if (mIsFile.get(position)) {
                    final String nodePath = mRootPath + mNodeAdapter.get(position);
                    beginMonitor("cat " + nodePath);
                    return true;
                }
                return false;
            }
    ...
    public void beginMonitor(String cmd){
        ...
        monitorService.putExtra("command", cmd);
    ...
    public Handler mHandler = new Handler() {
        public void handleMessage(Message msg) {
            if (msg.what == 0x11) {
                ...
                showAlergDialog(NodeViewActivity.this, title, cr.successMsg + " " + cr.errorMsg);
            }
        }
    };
    ...
    public void showAlergDialog(Context context, String title,
        ...
        new AlertDialog.Builder(context)
                .setTitle(title)
                .setMessage(message)
                .setNeutralButton(R.string.title_monitor, new DialogInterface.OnClickListener() {
                    @Override
