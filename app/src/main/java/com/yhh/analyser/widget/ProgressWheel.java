...
public class ProgressWheel extends View {
    ...
    private int barExtraColor = 0xAA000000;
    ...
    private Paint barExtraPaint = new Paint();
    ...
    private void setupPaints() {
        ...
        barExtraPaint.setColor(barExtraColor);
        barExtraPaint.setAntiAlias(true);
        barExtraPaint.setStyle(Style.STROKE);
        barExtraPaint.setStrokeWidth(barWidth);
    ...
    private void parseAttributes(TypedArray a) {
        ...
        barExtraColor = a.getColor(R.styleable.ProgressWheel_barExtraColor, barExtraColor);
        ...
        textColor = a.getColor(R.styleable.ProgressWheel_WheeltextColor,
                textColor);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //add by yhh
        if(isExtra){
            canvas.drawArc(circleBounds, progress - 90, progressExtra, false, barExtraPaint);
        }
    ...
    */
    ...
    /**
     * Increment the progressExtra by 1 (of 360)
     */
    public void incrementProgressExtra() {
        isExtra = true;
        progressExtra++;
        if (progressExtra > 360)
            progressExtra = 0;
        postInvalidate();
//        isExtra = false;
    }
    ...
    public int getBarExtraColor() {
        return barExtraColor;
    }
    
    public void setBarExtraColor(int barExtraColor) {
        this.barExtraColor = barExtraColor;
        
        if ( this.barExtraPaint != null ) {
            this.barExtraPaint.setColor( this.barExtraColor );
        }
    }
