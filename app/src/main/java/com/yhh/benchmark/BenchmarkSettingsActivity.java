    ...
    public void initUI(){
        ...
        mThermalControlBtn.setOnCheckedChangeListener(new OnCheckedChangeListener(){
            ...
            public void onCheckedChanged(CompoundButton buttonView,
                ...
                mEditor.commit();
                RootTools.getInstance().startThermalEngine(!isChecked);
            }
        });
...
//      });
        //设置
        mCpuBigNumBar.setTickCount(MyPerf.CPU_BIG_NUM+1);
        mCpuSmallNumBar.setTickCount(MyPerf.CPU_LITTER_NUM+1);
        ...
        mGpuFreqBar.setOnRangeBarChangeListener(new RangeBar.OnRangeBarChangeListener() {
            @Override
            public void onIndexChangeListener(RangeBar rangeBar, int leftThumbIndex, int rightThumbIndex) {
                mGpufreqTv.setText("[  "+ MyPerf.GPU_FREQ[MyPerf.GPU_FREQ_NUM - leftThumbIndex -1] 
                        +",  " + MyPerf.GPU_FREQ[MyPerf.GPU_FREQ_NUM - rightThumbIndex - 1] +"  ]");
            }
        });
    ...
    public void readRefs(){
        ...
        mCpuBigfreqTv.setText("[  "+ MyPerf.CPU_BIG_FREQ[cpuBigFreqLower]/1000 
                +",  " + MyPerf.CPU_BIG_FREQ[cpuBigFreqUpper]/1000 +"  ]");
        mCpuSmallfreqTv.setText("[  "+ MyPerf.CPU_LITTER_FREQ[cpuSmallFreqLower]/1000 
                +",  " + MyPerf.CPU_LITTER_FREQ[cpuSmallFreqUpper]/1000+"  ]");
        mGpufreqTv.setText("[  "+ MyPerf.GPU_FREQ[MyPerf.GPU_FREQ_NUM - gpuFreqLower -1] 
                +",  " + MyPerf.GPU_FREQ[MyPerf.GPU_FREQ_NUM - gpuFreqUpper - 1] +"  ]");
    }
