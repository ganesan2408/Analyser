...
public class StackedBarChartItem extends ChartItem {
    
    
    public StackedBarChartItem(ChartData<?> cd, Context c, Boolean isPercentData) {
    ...
    public View getView(int position, View convertView, Context c) {
        ...
        holder.chart.setMaxVisibleValueCount(4);
