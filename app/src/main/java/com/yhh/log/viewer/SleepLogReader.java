...
public class SleepLogReader extends Activity {
    private static final String TAG =  ConstUtils.DEBUG_TAG+ "SleepLogReader";
        ...
        Log.i(TAG, "path =" + path);
            ...
            sta_button.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    myDialog = ProgressDialog.show(SleepLogReader.this,
                    ...
                    new Thread() {
                        public void run() {
                            ...
                            if (flg == 1) {
                                ...
                                intent.setClass(SleepLogReader.this,
                                        SleepLogStatistics.class);
