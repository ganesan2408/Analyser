...
// *
// */
//package com.yhh.terminal.backup;
//
...
//		PendingIntent contentIntent = PendingIntent.getActivity(getBaseContext(), 0, new Intent(this, MonitorAppActivity.class), 0);
...
//		initUI();
//
//		MonitorExceptionStat.getInstance().clear();
//
//		handler.post(task);
...
//                @Override
//                public void onClick(View v) {
////					ScreenShot.shoot(MonitorService.this);
...
//		}else{
//		    resultFilePath = AppConfig.MONITOR_DIR + "/" + mDateTime + "_" + appName;
//		}
//	}
//
