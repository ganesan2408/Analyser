...
public class TermSession {
    private static final String TAG = "YHH_TermSession";
...
//        String input = getCurrentChar(mReceiveBuffer, 0, bytesRead);
//        if(input !=null){
//            if(input.equals("8 8")){ //回退
//                Log.d(TAG,"huan hang.");
//                mCurrentInput.setLength(0);
//            }
//            mCurrentInput.append(input);
//            Log.d(TAG,"char="+input);
//            Log.d(TAG,"mCurrentInput="+mCurrentInput.toString());
//        }
        notifyUpdate();
    }
...
//     * by yhh
//     */
//    public String getCurrentChar(byte[] data, int base, int length){
//        Log.d(TAG,"length="+length);
//        if(data !=null){
//            return EmulatorDebug.bytesToString(data,base,length);
//        }else{
//            return null;
//        }
//    }
